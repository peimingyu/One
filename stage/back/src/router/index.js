...
//留言管理
import Leaving_add from '@/components/page/leaving/Leaving_add'
import Leaving_list from '@/components/page/leaving/Leaving_list'
...
export default new Router({
    routes: [{
        ...
        children: [{
            ...
            path: 'Leaving_add',
            name: 'Leaving_add',
            component: Leaving_add,
        }, {
            path: 'Leaving_list',
            name: 'Leaving_list',
            component: Leaving_list,
        }]
    }]
})