            ...
            <el-form :model="ruleForm" :rules="rules2" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <!--<el-form-item label="一级类名" prop="oneId">
                    <el-select v-model="ruleForm.oneId" placeholder="请选择" @change="changeClassOne()">
                        <el-option v-for="item in oneClass" :key="item.id" :label="item.cnname" :value="item.id" @click="fn()">
                        </el-option>
                    </el-select>
                ...
                <el-form-item label="时间" prop="times">
                    <el-date-picker v-model="timedata" type="datetime" placeholder="选择日期时间" @change="timefn" format="yyyy-MM-dd HH:mm:ss">
                    </el-date-picker>
                </el-form-item>
                <!--editor的div为富文本的承载容器-->
